    ...
    return (
        <main className="h-screen flex items-center justify-center">
            <form className="flex w-5/6 sm:w-2/3 flex-col gap-3 p-9 border rounded">
                ...
                <button type="submit" className="bg-neutral-50 p-3 mt-6 bg-fuchsia-600 hover:bg-fuchsia-900 rounded text-white">Sign in</button>
                <div className="mt-6 pt-3 border-t flex items-center justify-center">
                    <span className="text-sm">Don&apos;t have an account? <a href="/" className="underline text-fuchsia-900">Sign up</a></span>
                </div>
            </form>
        </main>
    )
